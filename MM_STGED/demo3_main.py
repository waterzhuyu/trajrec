...
from models.demo3 import MM_STGED, DecoderMulti, Encoder, SharedEmbedding
...
sys.path.append('../')
"""
python demo3_main.py --dataset Chengdu --data_ratio 1 > ./demo3/pretrain_Chengdu.txt 2>&1 &
python demo3_main.py --dataset Porto --data_ratio 1 --model_old_path /workspace/guozuyu/TrajectoryRecovery/MM_STGED/demo3/model/20241225_210245/ --finetune_flag True > demo3/pretrain_Porto.txt 2>&1 &
"""
...
if __name__ == '__main__':
    ...
    model_save_path = './demo3/model/'+time.strftime("%Y%m%d_%H%M%S") + '/'
    ...
    model = MM_STGED(enc, dec, shared_emb, args.num_emb, args.id_size, args.hid_dim, args.id_emb_dim, args.hid_dim, args.max_xid, args.max_yid, args.top_K).to(device)
