...
sys.path.append('../')
"""
python main_demo2_finetune.py --dataset Xian --finetune_flag True --model_old_path /workspace/guozuyu/TrajectoryRecovery/MM_STGED/demo2/20241217_123311/ --data_ratio 0.5 > demo2/finetune_xian_0.5.txt 2>&1 &
"""
...
if __name__ == '__main__':
    ...
    model_save_path = './finetune/'+time.strftime("%Y%m%d_%H%M%S") + '/'
