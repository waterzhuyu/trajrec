...
from models.multi_train import evaluate, init_weights, train_demo4
from models.demo4 import MM_STGED, DecoderMulti, Encoder, SharedEmbedding
...
"""
pretrain on Chengdu:
    python demo4_main.py --dataset Chengdu --data_ratio 1 > ./demo4/pretrain_Chengdu.txt 2>&1 &
pretrain on Porto:
    python demo4_main.py --dataset Porto --data_ratio 1 > ./demo4/pretrain_Porto.txt --model_old_path /workspace/guozuyu/TrajectoryRecovery/MM_STGED/demo4/model/20241230_155945/ --finetune_flag True 2>&1 &

finetune on Xi'an:
    python demo4_main.py --dataset Xian --data_ratio 0.01 > ./demo4/finetune_Xian_0.01.txt --model_old_path /workspace/guozuyu/TrajectoryRecovery/MM_STGED/demo4/model/20241230_155945/ --finetune_flag True 2>&1 &
    python demo4_main.py --dataset Xian --data_ratio 0.05 > ./demo4/finetune_Xian_0.05.txt --model_old_path /workspace/guozuyu/TrajectoryRecovery/MM_STGED/demo4/model/20241230_155945/ --finetune_flag True 2>&1 &
    python demo4_main.py --dataset Xian --data_ratio 0.1 > ./demo4/finetune_Xian_0.1.txt --model_old_path /workspace/guozuyu/TrajectoryRecovery/MM_STGED/demo4/model/20241230_155945/ --finetune_flag True 2>&1 &
    python demo4_main.py --dataset Xian --data_ratio 0.2 > ./demo4/finetune_Xian_0.2.txt --model_old_path /workspace/guozuyu/TrajectoryRecovery/MM_STGED/demo4/model/20241230_155945/ --finetune_flag True 2>&1 &
    python demo4_main.py --dataset Xian --data_ratio 0.3 > ./demo4/finetune_Xian_0.3.txt --model_old_path /workspace/guozuyu/TrajectoryRecovery/MM_STGED/demo4/model/20241230_155945/ --finetune_flag True 2>&1 &
    python demo4_main.py --dataset Xian --data_ratio 0.5 > ./demo4/finetune_Xian_0.5.txt --model_old_path /workspace/guozuyu/TrajectoryRecovery/MM_STGED/demo4/model/20241230_155945/ --finetune_flag True 2>&1 &
    python demo4_main.py --dataset Xian --data_ratio 1 > ./demo4/finetune_Xian_1.txt --model_old_path /workspace/guozuyu/TrajectoryRecovery/MM_STGED/demo4/model/20241230_155945/ --finetune_flag True 2>&1 &
"""

if __name__ == '__main__':
    
    parser = argparse.ArgumentParser(description='Multi-task Traj Interp')
    parser.add_argument('--dataset', type=str, default='Xian',help='data set')
    ...
    #FIXME: Replace to demo4
    model_save_path = './demo4/model/'+time.strftime("%Y%m%d_%H%M%S") + '/'
    ...
    model = MM_STGED(enc, dec, shared_emb, args.num_emb, args.id_size, args.hid_dim, args.id_emb_dim, args.hid_dim, args.num_layers, args.max_xid, args.max_yid, args.top_K).to(device)
    ...
    if opts.finetune_flag:
        ...
        model.decoder.load_state_dict(torch.load(args.model_old_path + 'dec-best-model.pt'))
    ...
    if args.train_flag:
        ...
        for epoch in tqdm(range(args.n_epochs)):
            ...
            train_rate_loss, train_id_loss = train_demo4(model, spatial_A_trans, road_condition, SE, train_iterator, optimizer, log_vars,
