...
def pretrain(model, spatial_A_trans_list, road_condition_list, SE_list, iterator_list, optimizer, log_vars, rn_dict_list, 
    ...
    for idx, batch_list in enumerate(zip_longest(city1_iterator, city2_iterator)):
        ...
        import time
        flag = True  # idenfity different city
