...
if __name__ == '__main__':
    ...
    parser.add_argument('--pro_features_flag', type=bool, default=False, help='flag of using profile features')
    parser.add_argument('--online_features_flag', type=bool, default=False, help='flag of using online features')
    parser.add_argument('--tandem_fea_flag', type=bool, default=False, help='flag of using tandem rid features')
    ...
    args_dict = {
        ...
        'poi_type':'company,food,shopping,viewpoint,house', # without poi
